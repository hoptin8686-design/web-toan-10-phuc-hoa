...
chcp 65001 > nul
echo ========================================================
echo   CHINH PHỤC TOÁN 10 — TRƯỜNG THPT PHỤC HÒA
...
cd /d "d:\Du-an-web\web-toan-10-phuc-hoa"
...
git add .
git commit -m "update: Cập nhật nội dung Toán 10 THPT Phục Hòa"
...
echo   Repo: https://github.com/hoptin8686-design/web-toan-10-phuc-hoa
